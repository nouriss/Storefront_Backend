...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hash, result, user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        console.log(" userStore:create ".concat(u.firstname, ", ").concat(u.lastname, ", ").concat(u.password));
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not add a new user  ".concat(u.firstname, "  Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET firstname=($2), lastname=($3), password_digest=($4) WHERE id=($1) RETURNING *;';
                        return [4 /*yield*/, conn.query(sql, [u.id, u.firstname, u.lastname, u.password])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Could not update user ".concat(u.firstname, "  Error: ").concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
